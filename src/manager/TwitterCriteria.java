...
public class TwitterCriteria {
    ...
    public TwitterCriteria setGeocode(String geocode) {
        this.geocode = geocode;
        return this;
    }

    public TwitterCriteria setEnglish(boolean english) {
        this.english = english;
        return this;
    }

    public TwitterCriteria setFeedType(Feeds feedType) {
        this.feedType = feedType;
        return this;
    }

    public Feeds getFeedType() {
        return feedType;
    }
